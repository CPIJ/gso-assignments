...
public class TimeSpan implements ITimeSpan {
    ...
    public void setBeginTime(ITime beginTime) {
        // Om de unit test 100% te hebben, moest de >= hier verangen worden door <=
    ...
    public ITimeSpan intersectionWith(ITimeSpan timeSpan) {
        ...
        /**
         * Om hier de 100% te halen, moest hij van te voren al gefixt worden:
         * Alle "<" moesten een ">" en ">" een "<" worden, zelfde met 
         * ">=" naar "<=" en "<=" naar "=>"
         */
